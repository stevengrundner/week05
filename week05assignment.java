...
//	5)	The SpacedLogger should add spaces between each character of the String argument passed into its methods.

//	6)	If the log method received “Hello” as an argument, it should print H e l l o

//	7)	The error method should do the same, but with “ERROR:” preceding the spaced out input (i.e. ERROR: H e l l o)
